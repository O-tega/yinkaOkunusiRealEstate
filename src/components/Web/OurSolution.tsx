...
const data = [
  {
    ...
    icon: <img src={ASSETS.GIFS.addExistingCustomers} alt="logos" className="w-full  md:w-[387px] border-[1rem] border-[#EBF1FF]" />,
  },
  {
    id: 2,
    ...
    icon: <img src={ASSETS.GIFS.realTImeAnalysis} alt="logos" className="w-full md:w-[387px] border-[1rem] border-[#EBF1FF]" />,
  },
  {
    id: 3,
    ...
    icon: <img src={ASSETS.GIFS.freeSupport} alt="logos" className="w-full md:w-[387px] border-[1rem] border-[#EBF1FF]" />,
  },
  // {
  //   id: 4,
