...
const data = [
  {
    ...
    icon: <img src={ASSETS.GIFS.addExistinggCustomer} alt="logos" className="w-full md:w-[387px]" />,
  },
  {
    id: 2,
    ...
    icon: <img src={ASSETS.GIFS.realTimeAnalytics} alt="logos" className="w-full md:w-[387px]" />,
  },
  {
    id: 3,
    ...
    icon: <img src={ASSETS.GIFS.getSupportForFree} alt="logos" className="w-full md:w-[387px]" />,
  },
  // {
  //   id: 4,
