...
const PurpleButton: FC<DeepBlueButtonProps> = ({ text, onClick, type = "button", disabled = false, css }) => {
  return (
    <button
      className={`text-white transition-fontWeight ease-in-out font-medium rounded-[8px] h-[45px] font-primary ${css} px-6 text-[14px] ${
        disabled
          ...
          : "bg-purple shadow-sm hover:bg-[#500BB7] hover:shadow-sm hover:font-bold"
      }`}
