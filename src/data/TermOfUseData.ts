export const termsOfUseStructure = [
	{
		type: "septet", // seven paragraph
		name: "",
		paragraph1:
		...
		paragraph5:
			"If you do not agree with (or cannot comply with) these Agreements, then you may not use the Service, but you can let us know by emailing compliance@mooyi.africa so we can try to find a solution. These Terms apply to all visitors, users and others who wish to access or use the Service.",
		paragraph6:
	...
	},
	{
		...
		listedItems: [
			"In any way that violates any federal, state or local law or regulation or professional rule applicable to you and your use of the Services, including, without limitation, those relating to client privacy including the Nigeria Data Protection Regulation (NDPR) and the Implementation framework, General Data Protection Regulation (GDPR) (which governs the users/members in European Economic Area (EEA), applicable EEA laws, the United Kingdom, or Switzerland national laws, or faxes or text messaging (the Telephone Consumer Protection Act).",
			...
			"To engage in any other conduct that inhibits anyone's use or enjoyment of the Service or which, as determined by us, may harm Mooyi or users of the Service.",
		],
		paragraph11: "Additionally, you agree not to:",
		listedItems2: [
			"Re-use or re-publish any content made available through the Service, including, without limitation, content posted by other Mooyi users, without the express written permission of Mooyi or such user, as applicable.",
			"Copy any material made available through the Service for commercial purposes, including through the scraping of content.",
			"Attempt to obtain unauthorised access to or interfere with the Service, any Mooyi computer system, software or network, including reverse engineering, decompiling, deriving source code or uploading malicious code or code snippets.",
			"Tamper with breach or attempt to probe, scan, or test for vulnerabilities in the Service or Mooyi’s computer systems, network, security elements, or any other protective measures associated with the Service.",
			...
			"Reproduce or redistribute content provided through the Services, including through “framing” or “mirroring” or through third parties, without Mooyi’s consent.",
			...
			"infringe or use any of our brands, logos, trademarks or other proprietary marks in any business name, email, URL or other context, unless expressly approved by Mooyi in writing.",
	...
	{
		type: "quadruplet", // four paragraph
	...
	{
		type: "dual", // two paragraph
		name: "No Use By Minors",
		paragraph1:
	...
	{
		type: "nestedlisted", // two paragraph
		name: "User Content Rights and Related Responsibilities; Licences and Consent",
		paragraph1:
		...
		paragraph4: "You agree that your User Content will not:",
		listedItems: [
			...
			"Contain advertising or promotions not expressly authorised by Mooyi in writing.",
			...
			"If you believe that any content displayed on the Service violates your copyright, refer to Claims Regarding Copyright Infringement for instructions on sending us a notice of copyright infringement.",
		],
		paragraph11:
	...
	{
		type: "trio", // three paragraph
		name: "Web/App Contents and Communications",
		paragraph1:
		...
		paragraph2: `Any information received by you, either from the content of the website and app is not professional advice, content and use of service on our website/app https://mooyi.africa should not be considered factual information.`,
		paragraph3:
			"By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and any other information we may send. However, you may opt-out of receiving any or all of these communications from us by following the unsubscribe link or by emailing compliance@mooyi.africa ",
		paragraph4:
	...
	{
		type: "dual", // two paragraph,
		name: "Links to or Connections with Third-Party Sites or Applications",
		paragraph1:
	...
	},
	{
		...
		paragraph2:
			"If you are a copyright owner or authorised on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to compliance@mooyi.africa with the subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement.",
		paragraph3:
			"You may be held accountable for damages (including costs and attorneys’ fees) for misrepresentation or bad-faith claims on the infringement of any Content found on and/or through Service on your copyright.",
	},
	{
		type: "nestedList", // one paragraph,
		name: "Procedure for Copyright Infringement Claims",
		paragraph1:
		...
		paragraph11: "You can contact our Copyright Agent via email at compliance@mooyi.africa",
	},
	{
		type: "quadruple", // four paragraph
	...
	{
		type: "trio", // three paragraph
		name: "Reliance on Information Posted",
		paragraph1:
	...
	},
	{
		...
		paragraph2:
			"The parties acknowledge and agree that the Company has no obligation to make any commitment of work, time, or compensation to the User.",
	},
	{
		type: "basic", // one paragraph
		name: "Your Account",
		paragraph1:
			"You agree to (1) choose a strong password and keep it secure and confidential; (2) not permit others to use your login credentials to access your Mooyi account and (3) refrain from accessing another Mooyi member’s account. You agree you are solely responsible for your account. If you believe there has been unauthorised access to your account, you must change your username and password and notify us immediately. To close your account, please contact us at compliance@mooyi.africa As between you and others (including your employer), your account belongs to you. However, if you use a paid Service pursuant to an Enterprise Agreement, as described above, that enterprise will have the right to control access to and obtain reports on your use of the paid Service.",
	},
	{
		type: "quadruple", // four paragraph
		name: "Use of Account and Responsibilities",
		paragraph1:
	...
	{
		type: "trio", // three paragraph
		name: "Modifications, Termination, Interruption and Disruptions to the Platform.",
		paragraph1:
	...
	{
		type: "quadruple", // four paragraph
		name: "Fees, Payments and Compensation",
		paragraph1:
	...
	{
		type: "list", // four paragraph
		name: "Covenants, Warranties and Representations",
		listedItems: [
			...
			"The Provider agrees to provide an accurate representation of his/her skills, degrees, qualifications, background, and other information. The Professional agrees to not perform any Services or offer any advice in any jurisdiction where he/she is not authorised or licensed to do so. The Professional also agrees not to provide any Services without a licence in the relevant field of expertise, abiding by all relevant laws, rules, and regulations, including but not limited to rules of ethics and professional responsibility",
			"Professional will provide immediate written notice to the Company of any commencement or resolution of any investigation or proceeding by any licensing authority, governmental body or agency, any action of malpractice which is commenced, adjudicated or settled, or any change in status of his/her licence.",
			"The Professional agrees to ensure compliance with all applicable laws, rules and regulations, or policies imposed by an applicable regulatory or governmental authority in the course of the performance of Services.",
		],
	},
	{
		type: "trio", // three paragraph
	...
	},
	{
		...
		paragraph3:
			"Notices sent to the Company must be delivered by email to compliance@mooyi.africa.",
	},
	{
		type: "pentagon", // five paragraph
		name: "Miscellaneous",
		paragraph1:
	...
	},
	{
		...
		paragraph1:
			"If you have questions or comments about Mooyi Terms and Conditions, please email us at compliance@mooyi.africa",
		paragraph2: `You may provide us directly at legal@mooyi.africa with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (“Feedback”).`,
		paragraph3: `Or write to us at`,
		paragraph4: `complaince@mooyi.africa`,
		paragraph5: `ATTN: Data Protection Department`,
		paragraph6: `Mooyi`,
		paragraph7: `Lagos, Nigeria.`,
	},
];
