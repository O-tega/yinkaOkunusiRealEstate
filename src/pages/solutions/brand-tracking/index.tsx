  ...
  const cardData = [
    {
      ...
      img: <img src={ASSETS.MOOYI.SOLUTIONS.mooyibaton} alt="logos" className="w-[150px] md:w-[250px] md:pt-16" />,
      color: "bg-[#EBF1FF]",
    },
    {
      ...
      img: (
        <img src={ASSETS.MOOYI.SOLUTIONS.mooyiborderblocks} alt="logos" className="w-[120px] md:w-[150px] md:pt-10" />
      ),
      color: "bg-[#ECFEF5]",
    },
    {
      ...
      img: <img src={ASSETS.MOOYI.SOLUTIONS.mooyianalysis} alt="logos" className="w-[120px] md:w-[150px] md:pt-10" />,
      color: "bg-[#FEFAE8]",
    },
  ];
